  ...
  const sections = [
    {
      ...
      items: [
        { to: '/services/female/hair', title: 'Hair', subtitle: 'Cuts, color & styling' },
        { to: '/services/female/skin', title: 'Makeup', subtitle: 'Bridal & party looks' },
        { to: '/services/female/body', title: 'Waxing', subtitle: 'Face, body & bikini' },
        // { to: '/services/female/manicure-pedicure', title: 'Manicure & Pedicure', subtitle: 'Nail care & polish' },
        { to: '/services/female/bridal', title: 'Bridal', subtitle: 'Complete bridal packages' },
      ],
    },
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto">
        <header className="mb-8 text-center">
          <h1 className="text-4xl font-bold text-purple-700 drop-shadow-sm">Explore All Services</h1>
          <p className="text-gray-900 mt-2">Browse our full range of salon services and pick what suits you best.</p>
        </header>
